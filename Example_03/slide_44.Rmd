...
CP0_substitute = quote( dose_RespPK)
...
H10_substitute = do.call( 'substitute', list( KINB, list( CP0 = CP0_substitute ) ) )
...
H20_substitute = do.call( 'substitute', list( H20_substitute, list( CP0 = CP0_substitute ) ) )
H30_substitute = do.call( 'substitute', list( H30_substitute, list( CP0 = CP0_substitute ) ) )
...
cond_init = function( dose_RespPK )
{
  ...
  H10_init = ( 1.0 + SM1_init * CP0_init / (SC1_init + CP0_init ) )
  H20_init = ( 1.0 + SM2_init * CP0_init / (SC1_init + CP0_init ) )
  H30_init = ( 1.0 + SM3_init * CP0_init/ (SC1_init + CP0_init ) )
  
  KINB_init = KMT_init * NB0_init / H10_init
  KBB1_init = THETA12
  KTT_init = THETA13
  KD_init = THETA7
  
  BM10_init = ( KINB_init * H10_init / (KBB1_init * H30_init + KTT_init * H20_init ) )
  BM20_init = ( KTT_init * H20_init * BM10_init/(KBB1_init * H30_init + KTT_init * H20_init ) )
  BM30_init = ( KTT_init * H20_init * BM20_init/(KBB1_init * H30_init + KTT_init * H20_init ) )
  BM40_init = ( KTT_init * H20_init * BM30_init/(KBB1_init * H30_init + KTT_init * H20_init ) )
  BM50_init = ( KTT_init * H20_init * BM40_init/(KBB1_init * H30_init + KTT_init * H20_init ) )
  BM60_init = ( KTT_init * H20_init * BM50_init/(KBB1_init * H30_init + KTT_init * H20_init ) )
  BM70_init = ( KTT_init * H20_init * BM60_init/(KBB1_init * H30_init + KTT_init * H20_init ) )
  BM80_init = ( KTT_init * H20_init * BM70_init/(KBB1_init * H30_init + KTT_init * H20_init ) )
  BM90_init = ( KTT_init * H20_init * BM80_init/(KBB1_init * H30_init + KTT_init * H20_init ) )
  
  # arms initial conditions
  ABS  = 0
  
  # CENT
  AC0_init = CP0_init * VD_init
  NT0_init  = BM10_init + BM20_init + BM30_init + BM40_init + BM50_init + BM60_init + BM70_init + BM80_init + BM90_init + NB0_init
  RTOT0_init = KSI_init*NT0_init
  ADR0_init  = RTOT0_init*AC0_init/(KD_init+CP0_init)
  CENT = AC0_init + ADR0_init
...
cond_init_arm1 = cond_init( dose_RespPK = 0.1 )
cond_init_arm2 = cond_init( dose_RespPK = 0.3 )
cond_init_arm3 = cond_init( dose_RespPK = 1 )
cond_init_arm4 = cond_init( dose_RespPK = 31 )
cond_init_arm5 = cond_init( dose_RespPK = 10 )
cond_init_arm5 = cond_init( dose_RespPK = 30 )

arm1 = Arm( name="arm1", arm_size = 10, cond_init = cond_init_arm1 )
arm2 = Arm( name="arm2", arm_size = 10, cond_init = cond_init_arm2 )
arm3 = Arm( name="arm3", arm_size = 10, cond_init = cond_init_arm3 )
arm4 = Arm( name="arm4", arm_size = 10, cond_init = cond_init_arm4 )
arm5 = Arm( name="arm5", arm_size = 10, cond_init = cond_init_arm5 )
arm6 = Arm( name="arm6", arm_size = 10, cond_init = cond_init_arm6 )
