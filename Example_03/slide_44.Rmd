...
Deriv_CENT = do.call('substitute', list( Deriv_CENT, list( ADR = ADR ) ) )
...
H10 = do.call( 'substitute', list( H10, list( CP0 = CP0_substitute ) ) )

KINB = quote( KMT * NB0 / H10 )
KINB = do.call( 'substitute', list( KINB, list( H10 = H10_substitute ) ) )
...
H20 = do.call( 'substitute', list( H20, list( CP0 = CP0_substitute ) ) )
H30 = do.call( 'substitute', list( H30, list( CP0 = CP0_substitute ) ) )
...
Deriv_B2 = do.call('substitute', list(Deriv_B2, list( H1 = H1_substitute,
                                                      H2 = H2_substitute,
                                                      H3 = H3_substitute ) ) )

Deriv_B3 = do.call('substitute', list(Deriv_B3, list( H1 = H1_substitute,
                                                      H2 = H2_substitute,
                                                      H3 = H3_substitute ) ) )

Deriv_B4 = do.call('substitute', list(Deriv_B4, list( H1 = H1_substitute,
                                                      H2 = H2_substitute,
                                                      H3 = H3_substitute ) ) )

Deriv_B5 = do.call('substitute', list(Deriv_B5, list( H1 = H1_substitute,
                                                      H2 = H2_substitute,
                                                      H3 = H3_substitute ) ) )

Deriv_B6 = do.call('substitute', list(Deriv_B6, list( H1 = H1_substitute,
                                                      H2 = H2_substitute,
                                                      H3 = H3_substitute ) ) )

Deriv_B7 = do.call('substitute', list(Deriv_B7, list( H1 = H1_substitute,
                                                      H2 = H2_substitute,
                                                      H3 = H3_substitute ) ) )

Deriv_B8 = do.call('substitute', list(Deriv_B8, list( H1 = H1_substitute,
                                                      H2 = H2_substitute,
                                                      H3 = H3_substitute ) ) )

Deriv_B9 = do.call('substitute', list(Deriv_B9, list( H1 = H1_substitute,
                                                      H2 = H2_substitute,
                                                      H3 = H3_substitute ) ) )
...
Deriv_NB = do.call('substitute', list(Deriv_NB , list( H2 = H2_substitute,
                                                       H3 = H3_substitute ) ) )
...
CENT_init = do.call('substitute', list(CENT, list( AC0_init = AC0_init,
                                                   ADR0_init = ADR0_init) ) )
...
cond_init_arms = list( "ABS" = expression(0), 
                       "CENT" = expression(CENT_init), 
                       "FRR"  = expression(0),
                       "DR"   = expression(0),
                       "B1"   = expression(BM10_init),
                       "B2"   = expression(BM20_init),
                       "B3"   = expression(BM30_init),
                       "B4"   = expression(BM40_init),
                       "B5"   = expression(BM50_init),
                       "B6"   = expression(BM60_init),
                       "B7"   = expression(BM70_init),
                       "B8"   = expression(BM80_init),
                       "B9"   = expression(BM90_init),
                       "NB"   = expression(NB0_init ) )
