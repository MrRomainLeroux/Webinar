...
MyStatisticalModel = setParametersOdeSolver( MyStatisticalModel, list( atol=1e-4,
                                                                       rtol=1e-4,
                                                                       .relStep=1e-4 ) )
...
pKA = ModelParameter( "KA", mu = THETA2,
                      omega = sqrt( 0.00E+00 ),
                      fixedMu = FALSE,
                      fixedOmega = TRUE,
                      distribution = LogNormalDistribution() )

pKEL = ModelParameter( "KEL", mu = THETA5,
                       omega = sqrt( 3.12E-01),
                       fixedMu = FALSE,
                       fixedOmega = FALSE,
                       distribution = LogNormalDistribution() )

pVD = ModelParameter( "VD", mu = THETA6,
                      omega = sqrt( 3.28E-01 ),
                      fixedMu = FALSE,
                      fixedOmega = FALSE,
                      distribution = LogNormalDistribution() )
...
pKSI = ModelParameter( "KSI", mu = THETA9,
                       omega = sqrt( 2.24E-01 ),
                       fixedMu = FALSE,
                       fixedOmega = FALSE,
                       distribution = LogNormalDistribution() )
...
pNB0 = ModelParameter( "NB0", mu = THETA14,
                       omega = sqrt( 2.98E-01 ),
                       fixedMu = FALSE,
                       fixedOmega = FALSE,
                       distribution = LogNormalDistribution() )

pSC1 = ModelParameter( "SC1", mu = THETA15,
                       omega = sqrt(  8.03E-01 ),
                       fixedMu = FALSE,
                       fixedOmega = FALSE,
                       distribution = LogNormalDistribution() )

pSM1 = ModelParameter( "SM1", mu = THETA16,
                       omega = sqrt( 1.28E-02 ),
                       fixedMu = FALSE,
                       fixedOmega = FALSE,
                       distribution = LogNormalDistribution() )

pSM2 = ModelParameter( "SM2", mu = THETA17,
                       omega = sqrt( 0.0 ),
                       fixedMu = FALSE,
                       fixedOmega = TRUE,
                       distribution = LogNormalDistribution() )
...
p = ggplot( res, aes( x = time, y = RespPK  ) ) +
  geom_point() +
  geom_line() 
print( p )

p = ggplot( res, aes( x = time, y = RespPD  ) ) +
  geom_point() +
  geom_line() 
print( p )
